        ...
        <>
          <div className="summary-section">
            ...
            <div className="summary-block">
              ...
              <h4>Key Points</h4>
              <ul>
                {transcriptData.key_points?.length > 0 ? (
                  transcriptData.key_points.map((point, idx) => (
                    <li key={idx}>{point}</li>
                  ))
                ) : (
              ...
              <ul>
                {transcriptData.action_items?.length > 0 ? (
                  transcriptData.action_items.map((item, idx) => (
                    <li key={idx}>{item}</li>
                  ))
                ) : (
              ...
              <ul>
                {transcriptData.decisions_made?.length > 0 ? (
                  transcriptData.decisions_made.map((dec, idx) => (
                    <li key={idx}>{dec}</li>
                  ))
                ) : (
          ...
          {/* 🎧 Speaker-Labeled Transcript Section */}
          <div className="transcript-section">
            <h3>🗣️ Structured Transcript</h3>
            <div className="structured-transcript">
              {transcriptData.structured_transcript?.length > 0 ? (
                transcriptData.structured_transcript.map((entry, idx) => (
