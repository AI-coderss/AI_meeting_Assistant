      ...
      {diarizationSegments.length > 0 && (
        <div className="transcript-section">
          <div className="transcript-header">
            ...
            <div className="transcript-stats">
              {diarizationSegments.length} segments detected
            </div>
          </div>

          <div className="transcript-viewer">
            {diarizationSegments.map((segment, index) => (
              <div key={index} className="transcript-segment speaker-segment">
                <div className="segment-header">
                  <span className="speaker">🎤 {segment.speaker}</span>
                  <span className="timestamp">
                    {new Date(segment.start * 1000).toLocaleTimeString()} - {new Date(segment.end * 1000).toLocaleTimeString()}
                  </span>
                </div>
